...
export class Students implements OnInit, OnDestroy {
  ...
  studentNavGroups = [
    ...
    },
    {
      title: 'OBE & OUTCOMES',
      items: [
        { label: 'Course Outcomes (CO)', path: '/course-outcomes', icon: 'military_tech' },
        { label: 'Program Outcomes (PO)', path: '/program-outcomes', icon: 'track_changes' },
    ...
    },
    {
      ...
      items: [
        { label: 'Upcoming Exams', path: '/assessments', icon: 'assignment' },
        { label: 'Attendance %', path: '/attendance', icon: 'fact_check' },
        { label: 'Performance Analysis', path: '/performance', icon: 'insights' },
        { label: 'Semester Results', path: '/results', icon: 'assessment' }
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'File Grievance', path: '/grievance', icon: 'support_agent' },
        { label: 'Notifications', path: '/notifications', icon: 'notifications' },
        { label: 'My Profile', path: '/profile', icon: 'manage_accounts' }
      ]
    }
  ];
